                ...
                <Tabs defaultValue="review" className="w-full space-y-8">
                    ...
                    <TabsContent value="performance" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Card className="p-8 border-t-4 border-t-green-500 shadow-md">
                                ...
                                <div className="space-y-4">
                                    <p className="text-slate-600 leading-relaxed">
                                        You demonstrated strong foundational knowledge. Your ability to answer core concept questions correctly indicates a good grasp of the basics.
                                    </p>
                                    <ul className="space-y-2">
                                        <li className="flex items-start gap-2 text-sm text-slate-700">
                                            <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 shrink-0" /> Consistent performance in theory questions.
                                        </li>
                                        <li className="flex items-start gap-2 text-sm text-slate-700">
                                            <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 shrink-0" /> Good accuracy on easy/medium difficulty items.
                                        </li>
                                    </ul>
                                </div>
                            </Card>

                            <Card className="p-8 border-t-4 border-t-amber-500 shadow-md">
                                <h3 className="flex items-center gap-3 font-bold text-xl text-slate-900 mb-6">
                                ...
                                <div className="space-y-4">
                                    <p className="text-slate-600 leading-relaxed">
                                        There are opportunities to improve in advanced topics and scenario-based questions. Reviewing detailed explanations will help close these gaps.
                                    </p>
